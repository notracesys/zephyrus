...
export const translations = {
  en: {
    ...
    chat_final_msg_3: "Access to our **Unban Strategy** method cost $199.90, but I decided to lower it to only $19.90 to help those who really want their account back today.",
    chat_final_msg_4: "But attention: this promotional value is valid only for TODAY. Click the button below to guarantee your spot and recover your account now.",
  ...
  es: {
    ...
    chat_final_msg_3: "El acceso a nuestro método **Unban Strategy** costaba $199.90, pero decidí bajarlo a solo $19.90 para ayudar a quienes realmente quieren recuperar su cuenta hoy.",
    chat_final_msg_4: "Pero atención: este valor promocional es válido solo por HOY. Haz clic en el botón de abajo para asegurar tu lugar y recuperar tu cuenta ahora.",
  ...
  pt: {
    ...
    chat_final_msg_3: "O acesso ao nosso método **Unban Strategy** custava R$ 199,90, mas eu decidi baixar para apenas R$ 19,90 para ajudar quem realmente quer a conta de volta hoje.",
