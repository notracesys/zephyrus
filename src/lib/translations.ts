...
export const translations = {
  ...
  es: {
    ...
    chat_final_msg_4: "Pero atención: este valor promocional solo estará disponible hasta hoy. Haz clic en el botón de abajo para intentar recuperar su cuenta mientras haya tiempo.",
