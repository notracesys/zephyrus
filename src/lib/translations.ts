...
export const translations = {
  en: {
    ...
    chat_unban_story: "The clock is ticking! If we don't fix this fast, the robot will delete your data forever and then it's game over. Your diamonds and cool skins will be gone. We need to act now while the secret door is still open!",
  ...
  es: {
    ...
    chat_unban_story: "¡El tiempo corre! Si no arreglamos esto rápido, el robot borrará tus datos para siempre y será el fin. Tus diamantes y skins geniales se perderán. ¡Hay que actuar ahora mientras la puerta secreta sigue abierta!",
  ...
  pt: {
    ...
    chat_unban_story: "O tempo tá acabando! Se a gente não agir agora, o robô vai apagar seus dados pra sempre e aí já era. Suas skins raras e seus dima vão sumir. A gente precisa correr enquanto a porta secreta ainda está aberta!",
