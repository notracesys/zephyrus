...
export const translations = {
  en: {
    ...
    chat_final_msg_4: "But attention: this promotional price is valid for a limited time. Click the button below to try to recover your account while there's still time.",
  ...
  es: {
    ...
    chat_final_msg_4: "Pero atención: este valor promocional es por tiempo limitado. Haz clic en el botón de abajo para intentar recuperar su cuenta mientras haya tiempo.",
  ...
  pt: {
    ...
    chat_final_msg_4: "Mas atenção: esse valor promocional é por tempo limitado. Clique no botão abaixo para tentar recuperar sua conta enquanto ainda há tempo.",
