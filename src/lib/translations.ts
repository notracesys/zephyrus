...
export const translations = {
  en: {
    ...
    verify_error_not_found: "Could not find this account. Check the ID informed.",
    ...
    chat_unban_story: "The biggest mistake is sending just anything to support. If you just say 'please', the robot deletes your account instantly. They have no heart! Without the right secret, your skins are gone forever. Our method forces a human to read your case.",
    ...
    chat_final_msg_3: "Usually, this secret costs a lot of money, but today we're letting you in for just **$9.90** so you don't lose your account.",
    ...
    upsell_skip: "I don't want protection, access the method now",
  ...
  es: {
    ...
    verified: "Cuenta Encontrada",
    verify_error_not_found: "No se pudo encontrar esta cuenta. Verifique el ID informado.",
    player_nickname: "Apodo",
    player_level: "Nivel",
    ...
    chat_final_msg_3: "Normalmente este secreto cuesta mucho, pero hoy te lo dejamos por solo **$9.90** para que no pierdas tu cuenta.",
    ...
    delivery_important: "Importante: El acesso se permite solo una vez. Asegúrese de estar en uma conexão estável.",
    ...
    upsell_skip: "No quiero protección, acceder al método ahora",
  ...
  pt: {
    ...
    verified: "Conta Encontrada",
    verify_error_not_found: "Não foi possível encontrar essa conta. Verifique o ID informado.",
    player_nickname: "Apelido",
    player_level: "Nível",
    player_region: "Região",
    player_likes: "Likes",
    player_rank: "Patente",
    player_guild: "Guilda",
    ...
    chat_unban_story: "O maior erro é mandar qualquer coisa pro suporte. Se você só pedir 'por favor', o robô apaga sua conta na hora. Eles não têm coração! Sem o segredo certo, suas skins somem pra sempre. Nosso método obriga um humano a ler seu caso.",
    ...
    chat_final_msg_3: "Normalmente esse segredo custa muito caro, mas hoje a gente liberou por só **R$ 29,90** pra você não perder sua conta.",
    ...
    upsell_skip: "Não quero proteção, acessar o método agora",
    checkout_title: "Checkout Seguro",
    checkout_subtitle: "Complete seus dados para liberar a Estrategia Unban.",
