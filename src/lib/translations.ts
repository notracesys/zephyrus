...
export const translations = {
  en: {
    ...
    chat_final_msg_3: "Access to our Human Intervention Method cost $199.90, but I decided to lower it to only $19.90 to help those who really want their account back today.",
  ...
  es: {
    ...
    chat_final_msg_3: "El acceso a nuestro Método de Intervención Humana costaba $199.90, pero decidí bajarlo a solo $19.90 para ayudar a quienes realmente quieren recuperar su cuenta hoy.",
  ...
  pt: {
    ...
    chat_final_msg_3: "O acesso ao nosso Método de Intervenção Humana custava R$ 199,90, mas eu decidi baixar para apenas R$ 19,90 para ajudar quem realmente quer a conta de volta hoje.",
