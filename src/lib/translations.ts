...
export const translations = {
  en: {
    ...
    chat_final_msg_3: "Usually, this secret costs a lot of money, but today we're letting you in for just **$29.90** so you don't lose your account.",
  ...
  es: {
    ...
    chat_final_msg_3: "Normalmente este secreto cuesta mucho, pero hoy te lo dejamos por solo **$29.90** para que no pierdas tu cuenta.",
