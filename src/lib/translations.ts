...
export const translations = {
  en: {
    ...
    chat_initial_response: "👋 Hello! We received your info. After advanced technical analysis, we identified that your ID shows a 'false positive' pattern. This happens when the platform's automated system mistakes connection fluctuations for software use, causing an improper suspension. 📄",
    chat_msg_2: "🤔 Most bans happen by robots, without any human analysis. Sending a standard ticket now is risky: if the robot gives a 'copy and paste' twice, your ID goes into a permanent platform blacklist. 💡\n\nThis is exactly where {siteName} Team acts to force manual review. 💪",
    ...
    chat_unban_story: "Time is running against you. If manual review isn't requested in the first few hours, account transaction data is archived and recovery becomes impossible. The secret is to skip the screening AI that blocks 99% of players.",
    ...
    chat_final_msg_4: "But attention: this promotional price is only available until today. Click the button below to try to recover your account while there's still time.",
  ...
  es: {
    ...
    chat_initial_response: "👋 ¡Hola! Recibimos su información. Tras un análisis técnico avanzado, identificamos que su ID presenta un patrón de 'falso positivo'. Esto sucede cuando el sistema automático de la plataforma confunde oscilaciones de conexión con el uso de softwares, generando una suspensión indebida. 📄",
    chat_msg_2: "🤔 La mayoría de los baneos ocurren por robots, sin ningún análisis humano. Enviar un ticket común ahora es arriesgado: si el robot da 'copia y pega' dos veces, su ID entra en una lista negra definitiva de la plataforma. 💡\n\nAquí es exactamente donde actúa el Equipo {siteName} para forzar la revisión manual. 💪",
    ...
    chat_unban_story: "El tiempo corre en su contra. Si no se solicita la revisión manual en las primeras horas, los datos de transacciones de la cuenta se archivan y la recuperación se vuelve imposible. El secreto es saltarse la IA de triaje que bloquea al 99% de los jugadores.",
    ...
    chat_final_msg_3: "El acceso al método Unban Strategy costaba $199.90, pero decidimos bajarlo a solo **$19.90** para quienes realmente quieren intentar recuperar su cuenta hoy mismo.",
    chat_final_msg_4: "But attention: this promotional value will only be available until today. Click the button below to try to recover your account while there's still time.",
  ...
  pt: {
    ...
    chat_initial_response: "👋 Olá! Recebemos suas informações. Após uma análise técnica avançada, identificamos que seu ID apresenta um padrão de 'falso positivo'. Isso acontece quando o sistema automático da plataforma confunde oscilações de conexão com o uso de softwares, gerando uma suspensão indevida. 📄",
    chat_msg_2: "🤔 A maioria dos banimentos acontece por robôs, sem nenhuma análise humana. Enviar um ticket comum agora é arriscado: se o robô der 'copia e cola' duas vezes, seu ID entra em uma blacklist definitiva da plataforma. 💡\n\nAqui é exatamente onde a Equipe {siteName} atua para forçar a revisão manual. 💪",
    ...
    chat_unban_story: "O tempo corre contra você. Se a revisão manual não for solicitada nas primeiras horas, os dados de transação da conta são arquivados e a recuperação se torna impossível. O segredo é pular a IA de triagem que barra 99% dos jogadores.",
    chat_warning_title: "AVISO IMPORTANTE",
    ...
    chat_unban_strategy_intro: "Nós passamos meses testando padrões até encontrar a brecha. Foi assim que nasceu o Unban Strategy.",
    chat_final_msg_3: "O acesso ao método Unban Strategy custava R$ 199,90, mas baixamos para apenas **R$ 19,90** para quem quer tentar recuperar a conta hoje.",
    chat_final_msg_4: "Mas atenção: esse valor promocional só vai ficar disponível até hoje. Clique no botão abaixo para tentar recuperar sua conta enquanto ainda há tempo.",
