...
export const translations = {
  ...
  pt: {
    ...
    chat_final_msg_2: "Isso acontece porque o suporte é filtrado por robôr. Se você recebe isso, sua conta está condenada. Mas nós desenvolvemos um método que 'força' uma análise humana real. É impossível ser desbanido se apenas um robô ler sua mensagem, né? kkkkk",
