...
export const translations = {
  en: {
    ...
    chat_initial_response: "👋 Hey there! I looked at your ID and I have some news. The Garena robot made a mistake! It thought your internet lag was a hack and banned you for nothing. This is called a 'false positive' and it's super unfair. 📄",
    chat_msg_2: "🤔 You see, Garena uses robots to ban people, and these robots are kind of dumb. If you send a normal message to support, another robot will just say 'No' and you'll lose your account forever. Your skins, your levels... everything gone. 💡\n\nBut we found a secret way to skip the robots and talk to a real person.💪",
    ...
    chat_unban_story: "The clock is ticking! If we don't fix this fast, the robot will archive your data and then it's game over forever. Your diamonds and cool skins will be deleted. We need to act now while the secret door is still open!",
    chat_warning_title: "LOOK HERE!",
    chat_warning: "This secret trick only works because we found a tiny hole in Garena's system. If they find out, it's over. You need to do this now before they fix the hole!",
  ...
  es: {
    ...
    chat_initial_response: "👋 ¡Hola! Miré tu ID y tengo noticias. ¡El robot de Garena se equivocó! Pensó que tu lag de internet era un hack y te baneó por nada. Esto es injusto. 📄",
    chat_msg_2: "🤔 Verás, Garena usa robots para banear, y esos robots no son muy listos. Si mandas un mensaje normal, otro robot te dirá que 'No' y perderás tu cuenta para siempre. Tus skins, tus pases... todo a la basura. 💡\n\nPero nosotros encontramos un secreto para saltar los robots y hablar con una persona real. 💪",
    ...
    chat_unban_story: "¡El tiempo corre! Si não arreglamos esto rápido, el robot borrará tus datos y será el fin. Tus diamantes y skins geniales se perderán. ¡Hay que actuar ahora!",
    ...
    chat_final_msg_4: "¡Pero rápido! Este precio bajo es solo por hoy. ¡Haz clic abajo y recupera tu cuenta antes de que el robot a borre para siempre!",
  ...
  pt: {
    ...
    chat_initial_response: "👋 Oi! Analisei seu ID e tenho uma notícia pra te dar: O robô da Garena errou feio com você! Ele achou que sua internet ruim era hack e te baniu sem querer. Isso é um 'erro de sistema' e é muito injusto. 📄",
    chat_msg_2: "🤔 Sabe o que acontece? A Garena usa robozinhos pra banir as pessoas, e esses robôs erram muito. Se você mandar uma mensagem normal pro suporte, outro robô vai te dar um 'Não' automático e você vai perder sua conta pra sempre. Suas skins, passes, níveis... tudo jogado no lixo. 💡\n\nMas a gente descobriu um segredo pra pular os robôs e falar com uma pessoa de verdade lá dentro. 💪",
    ...
    chat_unban_story: "O tempo tá acabando! Se a gente não agir agora, o robô vai apagar seus dados pra sempre e aí já era. Suas skins raras e seus dima vão sumir. A gente precisa correr enquanto o segredo ainda funciona!",
    ...
    chat_final_msg_2: "Se você receber isso, sua conta já era. Mas o nosso jeito obriga uma pessoa de verdade a ler seu caso. Um robô não entende sentimentos, mas um humano vai ver que foi erro! Legal, né?",
