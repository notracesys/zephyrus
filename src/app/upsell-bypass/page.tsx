...
import { ShieldAlert, Zap, ArrowRight, Loader2, ShieldCheck, Lock, AlertTriangle } from 'lucide-react';
            ...
            <Card className="border-amber-500/30 bg-zinc-950/90 backdrop-blur-2xl shadow-[0_0_80px_-20px_rgba(245,158,11,0.4)] rounded-[2.5rem] overflow-hidden">
                <CardContent className="p-8 md:p-12 space-y-8">
                    ...
                    <div className="flex flex-col gap-6 pt-4">
                        ...
                        <button 
                          onClick={handleSkip}
                          className="text-zinc-500 hover:text-white transition-colors text-[10px] md:text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2"
                        >
                            {t.upsell_skip}
                        </button>
                    </div>
...
export default function UpsellBypassPage() {
  return (
